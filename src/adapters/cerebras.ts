...
const DEFAULT_MODELS: ModelInfo[] = [
  {
    id: 'gpt-oss-120b',
    providerId: 'cerebras', name: 'GPT-OSS 120B (Cerebras)',
    ...
    limitConfig: { rpm: 30, rpd: 900, tpm: 60_000, tpd: null, confidence: 'official' },
  },
  {
    id: 'llama3.1-8b',
...
export class CerebrasAdapter extends OpenAICompatAdapter {
  constructor() {
    ...
    super({
      ...
      defaultLimitConfig: { rpm: 30, rpd: 900, tpm: 60_000, tpd: null, monthlyRequests: null, monthlyTokens: null, confidence: 'official' },
