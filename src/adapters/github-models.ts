...
const DEFAULT_MODELS: ModelInfo[] = [
  {
    ...
    limitConfig: { rpm: 10, rpd: 50, tpm: null, tpd: null, confidence: 'observed' },
  },
  {
    id: 'gpt-4o-mini',
    ...
    limitConfig: { rpm: 15, rpd: 150, tpm: null, tpd: null, confidence: 'observed' },
  },
  {
    ...
    limitConfig: { rpm: 5, rpd: 50, tpm: null, tpd: null, confidence: 'observed' },
  },
  {
...
export class GitHubModelsAdapter extends OpenAICompatAdapter {
  constructor() {
    ...
    super({
      ...
      defaultLimitConfig: { rpm: 10, rpd: 50, tpm: null, tpd: null, monthlyRequests: null, monthlyTokens: null, confidence: 'observed' },
